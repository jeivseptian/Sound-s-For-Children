...
public class PearGame extends AppCompatActivity {

    private int presCounter = 0;
    private int maxPresCounter = 4;
    private String[] keys = {"P", "R", "A", "E"};
    private String textAnswer = "PEAR";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pear_game);
    ...
    private void doValidate() {
        ...
        if (editText.getText().toString().equals(textAnswer)) {
            Intent a = new Intent(PearGame.this, PearResult.class);
            startActivity(a);
            editText.setText("");
            finish();
        } else {
            mp = MediaPlayer.create(PearGame.this, R.raw.incorrect);
            mp.start();
            editText.setText("");
        }
