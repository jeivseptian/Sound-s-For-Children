...
public class PirGame extends AppCompatActivity {

    private int presCounter = 0;
    private int maxPresCounter = 3;
    private String[] keys = {"P", "R", "I"};
    private String textAnswer = "PIR";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pir_game);
    ...
    private void doValidate() {
        ...
        if (editText.getText().toString().equals(textAnswer)) {
            Intent a = new Intent(PirGame.this, PirResult.class);
            startActivity(a);
            editText.setText("");
            finish();
        } else {
            editText.setText("");
            mp=MediaPlayer.create(PirGame.this, R.raw.incorrect);
            mp.start();
        }
