...
public class LimeGame extends AppCompatActivity {

    private int presCounter = 0;
    private int maxPresCounter = 4;
    private String[] keys = {"L","M","E","I"};
    private String textAnswer = "LIME";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lime_game);
    ...
    private void doValidate(){
        ...
        if (editText.getText().toString().equals(textAnswer)){
            Intent a = new Intent(LimeGame.this, LimeResult.class);
            startActivity(a);
            editText.setText("");
            finish();
        }else {
            mp = MediaPlayer.create(LimeGame.this, R.raw.incorrect);
            mp.start();
            editText.setText("");
        }
