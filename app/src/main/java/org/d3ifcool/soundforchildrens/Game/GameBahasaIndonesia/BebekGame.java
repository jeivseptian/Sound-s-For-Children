...
public class BebekGame extends AppCompatActivity {

    private int presCounter = 0;
    private int maxPresCounter = 5;
    private String[] keys = {"B","B","E","K","E"};
    private String textAnswer = "BEBEK";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bebek_game);
    ...
    private void doValidate(){
        ...
        if (editText.getText().toString().equals(textAnswer)){
            Intent a = new Intent(BebekGame.this, BebekResult.class);
            startActivity(a);
            editText.setText("");
            finish();
        }else {
            editText.setText("");
            mp = MediaPlayer.create(BebekGame.this, R.raw.incorrect);
            mp.start();
        }
