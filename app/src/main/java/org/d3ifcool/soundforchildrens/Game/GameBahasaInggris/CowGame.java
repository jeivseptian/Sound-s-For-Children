...
public class CowGame extends AppCompatActivity {

    private int presCounter = 0;
    private int maxPresCounter = 3;
    private String[] keys = {"C","W","O"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cow_game);
    ...
    private void doValidate(){
        ...
        if (editText.getText().toString().equals(textAnswer)){
            Intent a = new Intent(CowGame.this, CowResult.class);
            startActivity(a);
            editText.setText("");
            finish();
        }else {
            mp = MediaPlayer.create(CowGame.this, R.raw.incorrect);
            mp.start();
            editText.setText("");
        }
